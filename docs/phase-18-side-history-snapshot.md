...
新增包：`src/main/java/com/navicode/snapshot/`
...
```text
~/.navicode/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dnavicode.snapshot.enabled=false
-Dnavicode.snapshot.max=50
-Dnavicode.snapshot.excludes=...
```
