...
```text
src/main/java/com/navicode/prompt/
...
2. 用户级覆盖：`~/.navicode/prompts/...`
3. 项目级覆盖：`.navicode/prompts/...`

例如：

```text
~/.navicode/prompts/base.md
~/.navicode/prompts/modes/agent.md
.navicode/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.navicode/prompts/...`
- [x] 支持项目级覆盖 `.navicode/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
