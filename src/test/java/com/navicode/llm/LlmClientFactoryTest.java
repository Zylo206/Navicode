...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        NavicodeConfig config = new NavicodeConfig();
        config.getProviders().put("glm",
                new NavicodeConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new NavicodeConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new NavicodeConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        NavicodeConfig config = new NavicodeConfig();
        config.getProviders().put("unknown", new NavicodeConfig.ProviderConfig("test-key", null, "unknown-model"));
