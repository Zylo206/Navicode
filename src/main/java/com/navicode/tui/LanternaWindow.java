...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(NavicodeConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("Navicode v16.0.0");
    ...
    public NavicodeConfig getConfig() {
        return config;
    }
}
