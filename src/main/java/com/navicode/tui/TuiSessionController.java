...
import com.navicode.tui.history.ConversationSnapshot;
import com.navicode.tui.pane.CenterPane;
import com.navicode.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final NavicodeConfig config;
    ...
    public TuiSessionController(NavicodeConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "navicode-tui-agent-runner");
