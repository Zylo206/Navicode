package com.navicode.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[navicode] stdout reader stopped: " + e.getMessage());
            }
        }, "navicode-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[navicode] stderr reader stopped: " + e.getMessage());
            }
        }, "navicode-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
