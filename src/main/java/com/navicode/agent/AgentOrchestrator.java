...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.navicode.skill.SkillRegistry skillRegistry,
                               com.navicode.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "navicode-multi-agent");
            t.setDaemon(true);
            return t;
        });
